...
fn test_no_self_call_1() {
    ...
    start_prank(CheatTarget::All, self);
    let call1 = Call {
        to: contract_address_const::<1>(), selector: 100, calldata: array![].span(),
    };
...
fn test_no_self_call_2() {
    ...
    start_prank(CheatTarget::All, self);
    let call1 = Call {
        to: contract_address_const::<2>(), selector: 100, calldata: array![].span(),
    };
    let call2 = Call {
        to: contract_address_const::<3>(), selector: 200, calldata: array![].span(),
    };
