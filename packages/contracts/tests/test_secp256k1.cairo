...
const message_hash_low_even: felt252 =
    0x100009c0758efbb5aa07d35ed5454d728637fceab7ba544d3ea954030000000;
...
const message_hash_low_odd: felt252 =
    0x100009c0758efbb5aa07d35ed5454d728637fceab7ba544d3ea954030000003;
...
const message_hash_high_even: felt252 =
    0x100009c0758efbb5aa07d35ed5454d728637fceab7ba544d3ea954030000001;
...
const message_hash_high_odd: felt252 =
    0x100009c0758efbb5aa07d35ed5454d728637fceab7ba544d3ea954030000002;
...
fn validateK1Signature(r: u256, s: u256, y_parity: bool, message_hash: felt252) -> bool {
    let sig = SignerSignature::Secp256k1(
        (
            Secp256k1Signer { pubkey_hash: pubkey_hash.try_into().unwrap() },
            Secp256Signature { r, s, y_parity },
        ),
    );
...
fn test_successful_verification_low_odd() {
    assert!(
        validateK1Signature(sig_r_low_odd, sig_s_low_odd, false, message_hash_low_odd),
        "invalid-verification-low-odd",
    );
}
